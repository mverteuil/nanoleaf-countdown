...
This file was copied from another repository before being modified.
...
def find_auroras(seek_time: float = 30):
                ...
                if new_location not in aurora_locations:
                    ...
                    if new_location == "":
                        ...
                        if broken not in broken_auroras:
                            ...
                            print(
                                "New Aurora found (deviceid: "
                                + broken
                                + "). But the device does not have an IP address."
                            )
                        return
    ...
    while time.time() < timeout:
        try:
            ...
            print(err)
            print(
                "If you are sure your network connection is working, "
                "please post an issue on the GitHub page: https://github.com/software-2/nanoleaf/issues"
            )
            print(
                "Please include as much information as possible, including your OS, "
...
def generate_auth_token(ip_address: str):
    ...
    if r.status_code == 401:
        print(
            "Not Authorized! I don't even know how this happens. "
            "Please post an issue on the GitHub page: https://github.com/software-2/nanoleaf/issues"
        )
